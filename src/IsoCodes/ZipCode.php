...
class ZipCode
{
     ...
     *
     * @return bool
     * @deprecated validate($zipcode, 'CA')
     */
     ...
     *
     * @return bool
     * @deprecated validate($zipcode, 'FR')
     */
     ...
     *
     * @return bool
     * @deprecated validate($zipcode, 'NL')
     */
     ...
     *
     * @return bool
     * @deprecated validate($zipcode, 'PT')
     */
     ...
     *
     * @return bool
     * @deprecated validate($zipcode, 'ES')
     */
